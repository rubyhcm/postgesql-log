...
\begin{center}
\includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{img/mermaid/arch_overview.png}
...
\begin{center}
\includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{img/mermaid/er_diagram.png}
...
\begin{itemize}
    ...
    \item B-tree index cho (\texttt{changed\_at}), (\texttt{table\_name}, \texttt{changed\_at}),\\ (\texttt{user\_name}, \texttt{changed\_at}).
\end{itemize}
